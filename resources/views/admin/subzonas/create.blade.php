    ...
    <form action="{{ route('admin.subzonas.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-3">
            ...
            <div class="col-12">
                ...
                <textarea name="resumen" class="form-control" rows="3" maxlength="300" placeholder="Resumen breve para mostrar en listados y cabeceras..."></textarea>
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="estado" class="form-control" placeholder="Ej: En construcción, Disponible...">
            </div>
